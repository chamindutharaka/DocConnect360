            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col items-start gap-10 text-gray-600 lg:flex-row'>
                    <div className='flex flex-col w-full gap-4 lg:flex-1'>
                        ...
                        <div className='flex flex-col flex-1 gap-1'>
                            <p>Doctor Email</p>
                            <input onChange={e => validateEmail(e.target.value)} value={email} className='px-3 py-2 border rounded' type="email" placeholder='Email' required />
                            {emailError && <p className='text-sm text-red-500'>{emailError}</p>}
                        </div>

                        <div className='flex flex-col flex-1 gap-1'>
                            <p>Set Password</p>
                            <input onChange={e => validatePassword(e.target.value)} value={password} className='px-3 py-2 border rounded' type="password" placeholder='Password' required />
                        ...
                        <div className='flex flex-col flex-1 gap-1'>
                            <p>Experience</p>
                            <select onChange={e => setExperience(e.target.value)} value={experience} className='px-2 py-2 border rounded'>
                                {[1,2,3,4,5,6,8,9,10].map(y => <option key={y} value={`${y} Year`}>{y} Year{y > 1 && 's'}</option>)}
                            </select>
                        </div>
