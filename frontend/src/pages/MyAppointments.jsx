...
//         const tableColumn = ["Doctor", "Speciality", "Date", "Time", "Status"];
//         const tableRows = [];
...
//                 item.slotTime,
//                 item.cancelled ? "Cancelled" : item.isCompleted ? "Completed" : item.payment ? "Paid" : "Pending"
//             ];
...
//                             )}
//                             {item.isCompleted && (
//                                 <button className='py-2 text-green-500 border border-green-500 rounded sm:min-w-48'>Completed</button>
//                             )}
...
//                             )}
//                             {item.cancelled && !item.isCompleted && (
//                                 <button className='py-2 text-red-500 border border-red-500 rounded sm:min-w-48'>Appointment cancelled</button>
//                             )}
//                         </div>
//                     </div>
//                 ))}
